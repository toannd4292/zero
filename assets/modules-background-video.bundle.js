  ...
  Alpine.data('ThemeModule_BackgroundVideo', _ref => {
    ...
    return {
      ...
      _init() {
        ...
        this.$root.addEventListener('cascade:video-component:visible', this.eventHandlers.inView);
        this.$root.addEventListener('cascade:video-component:not-visible', this.eventHandlers.outOfView);
      },
